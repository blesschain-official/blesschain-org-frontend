...
const useCases = [
  { title: 'Retail Delivery', bullets: ['Multi-location routing', 'Real-time stock sync'] },
  { title: 'Restaurants', bullets: ['Driver assignment', 'Hot food delivery accuracy'] },
  { title: 'Logistics Companies', bullets: ['Multi-route optimization', 'Digital proof-of-delivery'] },
  { title: 'Warehouses', bullets: ['AI-based order batching'] },
];
    ...
    <section className="bg-[#0E0E12] py-14">
      <div className="mx-auto flex max-w-5xl flex-col gap-6 px-6 text-white">
        <div className="space-y-3">
          ...
          <h2 className="text-3xl font-semibold text-[#f6f0dd] sm:text-[34px]">Where BlessShipping Delivers</h2>
        </div>

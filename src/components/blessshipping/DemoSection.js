    ...
    <section className="bg-[#0B0E19] py-14">
      <div className="mx-auto flex max-w-5xl flex-col gap-6 px-6 text-white">
        <div className="space-y-3">
          ...
          <h2 className="text-3xl font-semibold text-[#f6f0dd] sm:text-[34px]">See BlessShipping in Action</h2>
        </div>
        <div className="grid gap-4 sm:grid-cols-3">
          {['Driver assignment screen', 'Route optimization map', 'Delivery status tracking interface'].map((item) => (
